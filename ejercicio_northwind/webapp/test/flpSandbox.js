		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ejercicio Northwind Title",
									"targetURL": "#comproyejercicionorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comproyejercicionorthwind-display": {
								"semanticObject": "comproyejercicionorthwind",
								"action": "display",
								"description": "A Ejercicio Northwind application.",
								"title": "Ejercicio Northwind Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.proy.ejercicionorthwind",
									"url": sap.ui.require.toUrl("com/proy/ejercicionorthwind")
								}
							}
						}
					}
